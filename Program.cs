...
// TimeOnly opening = new TimeOnly(8, 0);
// TimeOnly closing = new TimeOnly(17, 0);

// Listing aList = new Listing("12", "Mike Jones", "4/3/2023", "11:30 AM", 30.50, "Cancelled");
...
// aList.SetTime(TimeOnly.Parse(aList.GetTime()).AddHours(1).ToString());
// System.Console.WriteLine(aList.GetTime()); 
// outFile.Close();
// if(TimeOnly.Parse(aList.GetTime()).IsBetween(opening, closing)){
//     System.Console.WriteLine("We're open!");
// }
